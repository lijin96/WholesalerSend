...
public class UpdateManager {
        ...
        private Runnable mdownApkRunnable = new Runnable() {
            ...
            public void run() {
                try {
                    SysUserInfo sysinfo = new SysUserInfo(mContext);
//                    Log.d("main","测试-"+sysinfo.getApkUrl());
...
//        String directory = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getPath();
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri uri = FileProvider.getUriForFile(mContext, "com.example.wholesalersend.fileprovider", apkFile);//第二个参数要和Mainfest中<provider>内的android:authorities 保持一致

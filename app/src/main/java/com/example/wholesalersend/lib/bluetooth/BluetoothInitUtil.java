...
public class BluetoothInitUtil {
     ...
     */
    public static Object[] initBluetoothWithAutoConnect(Context context, Handler handler, SysUserInfo sysUserInfo,Button btn_connect, TextView tv_connect_state) {
        // 使用全局蓝牙管理器

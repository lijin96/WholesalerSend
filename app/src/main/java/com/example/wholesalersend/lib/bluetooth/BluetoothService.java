...
public class BluetoothService {
        ...
        public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
            ...
            // 发送蓝牙名称和地址到uiactivity（在状态更新之后发送，确保UI能正确显示）
        ...
        private void connectionLost() {
            ...
            Message msg = mHandler.obtainMessage(BluetoothUtil.MESSAGE_TOAST);
            Bundle bundle = new Bundle();
            bundle.putString(BluetoothUtil.TOAST, "断开蓝牙连接");
            msg.setData(bundle);
            mHandler.sendMessage(msg);
        }
        ...
        private class ConnectThread extends Thread {
            ...
            public void run() {
                ...
                try {
                    ...
                    // 如果标准连接失败，尝试使用反射方法重连（某些设备需要）
                    boolean retryWithReflection = false;
                    if (mmSocket != null) {
                        try {
                            // 关闭失败的socket
                            try {
                            ...
                            // 使用反射方法创建新的socket并连接
                            java.lang.reflect.Method m = mmDevice.getClass().getMethod("createRfcommSocket", new Class[] { int.class });
                            BluetoothSocket fallbackSocket = (BluetoothSocket) m.invoke(mmDevice, 1);

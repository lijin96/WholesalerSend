...
public class BluetoothStateHandler {
     ...
     */
    public static boolean handleBluetoothStateChange(Message msg, Button btn_connect, TextView tv_connect_state, String connectedDeviceName, String connectedDeviceAddress, SysUserInfo sysUserInfo) {

...
/**
 * @ClassName: P_Dv_InStock_Bill
 * @Description: 有单有明细入库
 * @Author: lijin
 * @Date: 2021/3/10 13:58
 */
public class P_Dv_InStock_Bill extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_instock_bill);
...
//        }
        ...
        tv_title.setText("【有单有明细入库】 "+sysUserInfo.getAccountSetName());
            ...
            switch (msg.what) {
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.print(P_Dv_InStock_Bill.this, "           有单入库", mark, sacnDataList, sysUserInfo.getUserName());

...
public class P_Dv_InStock_PackBox_Search extends Activity implements View.OnClickListener {
    ...
    private Button btn_connect, btn_again_print_boxcode;
...
//        });
        ...
        tv_title.setText("【补打盒标】 "+sysUserInfo.getAccountSetName());
        ...
        if (bluetoothManager.isBluetoothAvailable()) {
            ...
            if (!bluetoothManager.isBluetoothConnected()) {
                ...
                boolean isAutoConnecting = bluetoothManager.initBluetoothServiceAndAutoConnect(this, mHandler, true);
                if (isAutoConnecting) {
                    // 正在自动连接，更新UI状态
    ...
    public void printBoxCode(BoxTag boxTag) {
        ...
        if (isFileExists("lab_" + sysUserInfo.getEnterpriseId().toString() + ".txt")) {
            if (boxTag.getModel().equals("")&&boxTag.getColor().equals("")){
    ...
    private void sendMessage(String message, BoxTag boxTag) {
        ...
        if (isFileExists("lab_" + sysUserInfo.getEnterpriseId().toString() + ".txt")) {
            ...
            if (boxTag.getModel().equals("")&&boxTag.getColor().equals("")) {
                ...
                message = message.replace("%U", boxTag.getBoxNo());

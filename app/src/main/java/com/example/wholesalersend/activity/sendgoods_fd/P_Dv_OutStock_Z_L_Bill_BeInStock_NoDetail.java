...
/**
 * @ClassName: P_Dv_OutStock_Z_L_Bill_BeInStock_NoDetail
 * @Description: 总公司有单有入库无明细分店发货
 * @Author: lijin
 * @Date: 2021/3/10 14:03
 */
public class P_Dv_OutStock_Z_L_Bill_BeInStock_NoDetail extends Activity {
...
//	private List<String> codesList= new ArrayList<String>();
    ...
    private String GoodsOrderType="";//满赠
    private RadioGroup radio_group;
    private RadioButton radio_manzen,radio_manzheng;//满赠还是满正
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_outstock_z_l_bill_beinstock_nodetail);
...
//        }
        ...
        tv_title.setText("【有单有入库无明细分店发货】 "+sysUserInfo.getAccountSetName());
...
//        Log.d("main","随机数："+scanBillno);
        ...
        radio_manzen=findViewById(R.id.radio_manzen);
        radio_manzheng=findViewById(R.id.radio_manzheng);
        radio_group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                int id = radioGroup.getCheckedRadioButtonId();
                switch (radioGroup.getCheckedRadioButtonId()) {
                    case R.id.radio_manzen:
                        GoodsOrderType="满赠";
                        break;
                    case R.id.radio_manzheng:
                        GoodsOrderType="满正";
                        break;
                }
            }
            ...
            switch (msg.what) {
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.prints("    有单有入库直销发货", mark, sacnDataList, sysUserInfo.getUserName());

                    } else {

                        printbill.print(P_Dv_OutStock_Z_L_Bill_BeInStock_NoDetail.this, "    有单有入库直销发货", mark, sacnDataList, sysUserInfo.getUserName());
...
//                    para.setGoodsOrderType(GoodsOrderType);
//                    Log.d("main",para.toString());
                    result = accWeb.P_Dv_Scan("P_Dv_OutStock_D_L_Bill_BeInStock", para.toJson());

        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                        ...
                        list = accWeb.GetScsPurOrderLensDetail(sourceBillNo,et_search.getText().toString());
...
//            Intent intent  = new Intent(mContext, CheckLensDegree.class);
            ...
            intent.putExtra("GoodsCode", (String) item.get("GoodsCode"));
            intent.putExtra("scanBillno", scanBillno);
...
//        Collections.sort(mList, new SortListMapComparator("PurOrderNo"));
        ...
        SimpleAdapter adapter = new SimpleAdapter(this, mList, R.layout.list_purcheck_lens_detail,
                new String[]{"GoodsCode", "GoodsName", "RefractiveIndex", "NoInGoodQty"}, new int[]{R.id.txt_list1, R.id.txt_list2, R.id.txt_refractivity, R.id.txt_list4});

 ...
 */
public class P_Dv_OutStock_Lens_Z_L_Bill_BeInStock extends Activity {
...
//	private List<String> codesList= new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_outstock_lens_z_l_bill_beinstock);
        ...
        tv_title.setText("【镜片有单有入库分店发货】 "+sysUserInfo.getAccountSetName());
...
//                    tv_model_colors.setText(modelm + "-" + colors);
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.print(P_Dv_OutStock_Lens_Z_L_Bill_BeInStock.this, "    有单有入库直销发货", mark, sacnDataList, sysUserInfo.getUserName());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_OutStock_D_L_Lens_Bill_BeInStock", para.toJson());
//                    Log.d("main",result);
                    if (result == "") {
                        MySound.errorSound();
                        ShowMessage.ShowMsg(handler, "网络不给力，请稍后再试！");

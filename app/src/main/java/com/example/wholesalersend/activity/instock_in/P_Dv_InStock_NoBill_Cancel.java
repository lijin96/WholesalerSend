...
/**
 * @ClassName: P_Dv_InStock_NoBill_Cancel
 * @Description: 无单入库撤销
 * @Author: lijin
 * @Date: 2021/3/10 13:59
 */
public class P_Dv_InStock_NoBill_Cancel extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_instock_cancel_nobill);
...
//        }
        ...
        tv_title.setText("【无单入库撤销】 "+sysUserInfo.getAccountSetName());
            ...
            switch (msg.what) {
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.prints("         无单入库撤销", mark, sacnDataList, sysUserInfo.getUserName());

                    } else {

                        printbill.print(P_Dv_InStock_NoBill_Cancel.this, "         无单入库撤销", mark, sacnDataList, sysUserInfo.getUserName());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_InStock_NoBill_Cancel", para.toJson());

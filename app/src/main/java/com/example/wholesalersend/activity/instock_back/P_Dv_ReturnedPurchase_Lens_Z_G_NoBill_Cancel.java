...
//        }
        ...
        tv_title.setText("【无单镜片入库退回撤销】 "+sysUserInfo.getAccountSetName());
...
//                    tv_model_colors.setText(modelm + "-" + colors);
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.print(P_Dv_ReturnedPurchase_Lens_Z_G_NoBill_Cancel.this, "      无单入库退回撤销", mark, sacnDataList, sysUserInfo.getUserName());

...
/**
 * @ClassName: P_Dv_InStock_Z_ChangeStock_Bill
 * @Description: 有单调拨
 * @Author: lijin
 * @Date: 2021/3/10 14:00
 */
public class P_Dv_InStock_Z_ChangeStock_Bill extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_instock_z_changestock_bill);
...
//                .setOnClickListener(new BtnSelectProductClick());
        ...
        tv_title.setText("【仓库有单调拨】 "+sysUserInfo.getAccountSetName());
...
//                    }
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        printbill.prints("         仓库有单调拨", mark, sacnDataList, sysUserInfo.getUserName());
                    } else {
                        printbill.print(P_Dv_InStock_Z_ChangeStock_Bill.this, "         仓库有单调拨", mark, sacnDataList, sysUserInfo.getUserName());
                    }
                    break;
...
//                    Log.d("main",para.toString());
                    ...
                    nSize++;
                    //true;产品编号,型号,色号,当前型号数量,当前扫描的条码,调拨单号(注：返回此单号无作用)
                    goodsid = rest[0].trim();
                    modelm = rest[1].trim();
                    colors = rest[2].trim();

...
/**
 * @ClassName: P_Dv_InStock_Bill_NoDetail
 * @Description: 有单无明细入库
 * @Author: lijin
 * @Date: 2021/3/10 13:58
 */
public class P_Dv_InStock_Bill_NoDetail extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_instock_bill_nodetail);
//        details
        mContext = this;
...
//        }
        ...
        tv_title.setText("【有单无明细入库】 "+sysUserInfo.getAccountSetName());
            ...
            switch (msg.what) {
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.print(P_Dv_InStock_Bill_NoDetail.this, "           有单入库", mark, sacnDataList, sysUserInfo.getUserName());

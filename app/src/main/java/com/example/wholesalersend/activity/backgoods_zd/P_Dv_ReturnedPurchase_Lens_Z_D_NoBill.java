package com.example.wholesalersend.activity.backgoods_zd;
 ...
 */
public class P_Dv_ReturnedPurchase_Lens_Z_D_NoBill extends Activity {
    ...
    private String scanBillno = "", mBillNo = "", company_id = "", company_name = "",store_name="";//门店名称
...
//	Thread send ;
    ...
    private Button btn_returnedpurchase_z_d_nobille_revoke;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_returnedpurchase_lens_z_d_nobill);
...
//        }
        ...
        if (ChooseBillnum!=null&&ChooseBillnum!=""){
...
//        btn_returnedpurchase_z_d_nobille_revoke = (Button) findViewById(R.id.btn_returnedpurchase_z_d_nobille_revoke);
//        btn_returnedpurchase_z_d_nobille_revoke.setOnClickListener(new View.OnClickListener() {
//
//            @Override
...
//                R.layout.new_p_dv_returnedpurchase_z_d_nobill, null);
//        if (mPopWindow == null) {
...
//                    mark[2] = "门店名称：" + store_name;
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.prints("         镜片退货单", mark, sacnDataList, sysUserInfo.getUserName());

                    } else {

                        printbill.print(P_Dv_ReturnedPurchase_Lens_Z_D_NoBill.this, "         镜片退货单", mark, sacnDataList, sysUserInfo.getUserName());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_ReturnedPurchase_Lens_D_L_NoBill", para.toJson());
...
//                    company_name = rest[8].trim();
//                    store_name= rest[10].trim();

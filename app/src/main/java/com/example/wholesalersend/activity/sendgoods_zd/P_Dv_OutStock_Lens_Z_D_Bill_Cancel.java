 ...
 */
public class P_Dv_OutStock_Lens_Z_D_Bill_Cancel extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_outstock_lens_z_d_bill_cancel);
...
//                    tv_model_colors.setText(modelm + "-" + colors);
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.print(P_Dv_OutStock_Lens_Z_D_Bill_Cancel.this, "     有单代销发货撤销", mark, sacnDataList, sysUserInfo.getUserid());

...
/**
 * @ClassName: P_Dv_ReturnedPurchase_Lens_Z_L_NoBill_Cancel
 * @Description: 镜片无单分店退货撤销
 * @Author: lijin
 * @Date: 2024年3月27日15:46:12
 */
public class P_Dv_ReturnedPurchase_Lens_Z_L_NoBill_Cancel extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_returnedpurchase_lens_z_l_nobill_cancel);
...
//        }
        ...
        tv_title.setText("【镜片无单分店退货撤销】 "+sysUserInfo.getAccountSetName());
...
//                    tv_model_colors.setText(modelm + "-" + colors);
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.prints("     无单分店退货撤销", mark, sacnDataList, sysUserInfo.getUserName());

                    } else {

                        printbill.print(P_Dv_ReturnedPurchase_Lens_Z_L_NoBill_Cancel.this, "     无单分店退货撤销", mark, sacnDataList, sysUserInfo.getUserName());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_ReturnedPurchase_Lens_D_L_NoBill_Cancel", para.toJson());

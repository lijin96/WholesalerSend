...
/**
 * @ClassName: SelectLensProduct
 * @Description: 选择镜片产品
 * @Author: lijin
 * @Date: 2023/10/27 11:57
 */
public class SelectLensProduct extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_lens);
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    list = accWeb.GetDownSCSLoadGoodsInfor(et_search.getText().toString().trim(),1,"镜片");
    ...
    private class ListViewItemClik implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            if (lsv_aim.equals("P_Dv_InStock_Lens_Bill")){
                ...
                intent.putExtra("GoodsCode",  (String) item.get("GoodsId"));
                intent.putExtra("goodssyscode", (String) item.get("GoodsSysCode"));
                intent.putExtra("Refractive", (String) item.get("RefractiveIndex"));
            }
            intent.putExtra("Product_id", (String) item.get("GoodsId"));
            intent.putExtra("GoodsSysCode", (String) item.get("GoodsSysCode"));
            intent.putExtra("refractive", (String) item.get("RefractiveIndex"));
...
//        Collections.sort(mList, new SortListMapComparator("PurOrderNo"));
        ...
        SimpleAdapter adapter = new SimpleAdapter(this, mList, R.layout.list_goods_lens_detail,
                new String[]{"GoodsId", "BrandName","GoodsDescription", "RefractiveIndex"}, new int[]{R.id.txt_list1, R.id.txt_brand,R.id.txt_list2, R.id.txt_refractivity});

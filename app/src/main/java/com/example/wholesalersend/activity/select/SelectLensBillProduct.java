...
/**
 * @ClassName: SelectLensBillProduct
 * @Description: 查看镜片单据产品
 * @Author: lijin
 * @Date: 2023/10/27 11:57
 */
public class SelectLensBillProduct extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_query_scan_lens_detail);
...
//        et_search = (EditText) findViewById(R.id.et_search);
        ...
        if (lsv_aim != null && !lsv_aim.isEmpty()) {
            if ("P_Dv_OutStock_Lens_Z_L_Bill_BeInStock".equals(lsv_aim) ) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case ShowMessage.HandShowMessage: // 显示错误提示显示
                    ShowMessage.Show(SelectLensBillProduct.this, msg.obj.toString());
                    break;
...
//        Collections.sort(list, new SortListMapComparator("goodsid"));
        SimpleAdapter adapter = new SimpleAdapter(SelectLensBillProduct.this, list,
                R.layout.list_scan_lens_detail, new String[]{"BrandName","GoodsCode", "RefractiveIndex", "Diopter","Astigmatism", "NoSendGoodQty"},

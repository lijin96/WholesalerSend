 ...
 */
public class SelectBillProduct extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_select_bill_product);
        ...
        public void run() {
            try {
                ...
                if (lsv_aim.equals("P_Dv_InStock_Bill")) {
                    dataList = accWeb.GetDownLoadScsPurOrderDetail(orderno);
                }
//                //入库退回明细下载
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case ShowMessage.HandShowMessage: // 显示错误提示显示
                    ShowMessage.Show(SelectBillProduct.this, msg.obj.toString());
                    break;
...
//                    Log.d("main",dataList.toString());
    ...
    public void initListView(List<Map<String, Object>> list) {
        ...
        SimpleAdapter adapter = new SimpleAdapter(SelectBillProduct.this, list,
                R.layout.list_purcheck_detail, new String[]{"brandName","goodsid", "modelm", "colors", "noscanqty"},
                new int[]{R.id.txt_brand,R.id.txt_list1, R.id.txt_list2, R.id.txt_list3, R.id.txt_list4});

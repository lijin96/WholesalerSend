...
/**
 * @ClassName: P_Dv_ReturnedPurchase_L_D_Z_Frame
 * @Description: 镜架退货直通车
 * @Author: lijin
 * @Date: 2026/7/17 11:42
 */
public class P_Dv_ReturnedPurchase_L_D_Z_Frame extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p_dv_returnedpurchase_l_d_z_frame);
        ...
        tv_title.setText("【镜架退货直通车】 "+sysUserInfo.getAccountSetName());
...
//                    mark[2] = "门店名称：" + store_name;
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        printbill.prints("    镜架退货直通车", mark, sacnDataList, sysUserInfo.getUserName());

                    } else {
                        printbill.print(P_Dv_ReturnedPurchase_L_D_Z_Frame.this, "镜架退货直通车", mark, sacnDataList, sysUserInfo.getUserName());
                    }
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    String tListData = accWeb.PostAPIStringInterface("AndroidDv/P_Dv_ReturnedPurchase_L_D_Z_Frame",gson.toJson(map));

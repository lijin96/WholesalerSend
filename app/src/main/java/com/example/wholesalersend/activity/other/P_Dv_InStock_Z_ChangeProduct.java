...
/**
 * @ClassName: P_Dv_InStock_Z_ChangeProduct
 * @Description: 总公司入库换型号
 * @Author: lijin
 * @Date: 2026年6月10日13:56:51
 */
public class P_Dv_InStock_Z_ChangeProduct extends Activity {
    ...
    private String curcount = "0", goodsid = "", stock_id = "",goodssyscode="", mDocumentNo = "", stock_name;
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_instock_z_changeproduct);
...
//                    }
                ...
                case 8:
                    ...
                    mark[0] = "退回单：" + mBillNo;
                    mark[1] = "入库单：" + mDocumentNo;
                    //				mark[2] = "供应商："+tv_company_name.getText().toString();
                    //				mark[3] = "仓   库 ："+tv_stock_name.getText().toString();

                    printbill.print(P_Dv_InStock_Z_ChangeProduct.this, "           入库换型号", mark, sacnDataList, sysUserInfo.getUserid());
                    break;
                case 9:
                    MyProgressDialog.close();
                    ShowMessage.Show(mContext, msg.obj.toString());
...
//                    ArrayList<HashMap<Object, Object>> para = new ArrayList<HashMap<Object, Object>>();
                    ...
                    map.put("DocumentNo", mDocumentNo);//单号
                    map.put("GoodsSysCode", goodssyscode);//产品系统id

//                    result = accWeb.P_Dv_Scan("P_Dv_InStock_Z_ChangeProduct", para.toJson());
//                    Log.d("main", para.toJson());
                    String tListData = accWeb.PostAPIStringInterface("AndroidDv/ChangeProduct",gson.toJson(map));
...
//                    goodsid = jsonObject.optString("goodsCode");
                    ...
                    if (mBillNo == null || mBillNo.isEmpty()) {
                        ...
                        mDocumentNo =jsonObject.optString("documentNo");
                    }

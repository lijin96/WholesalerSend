 ...
 */
public class P_Dv_ReturnedPurchase_Lens_Z_D_NoBill_Cancel extends Activity {
...
//                    tv_model_colors.setText(modelm + "-" + colors);
                ...
                case 8:
                    ...
                    mark[0] = "撤销镜片退货单：" + mBillNo;

                    if (sysUserInfo.getOldVersion().equals("T8")) {

                        printbill.prints("     无单镜片退货撤销", mark, sacnDataList, sysUserInfo.getUserName());

                    } else {

                        printbill.print(P_Dv_ReturnedPurchase_Lens_Z_D_NoBill_Cancel.this, "     无单镜片退货撤销", mark, sacnDataList, sysUserInfo.getUserName());

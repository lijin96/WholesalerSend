...
/**
 * @ClassName: P_Dv_InStock_Lens_Bill_Cancel
 * @Description: 镜片有单入库撤销
 * @Author: lijin
 * @Date: 2024年3月27日13:47:54
 */
public class P_Dv_InStock_Lens_NoBill_Cancel extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_instock_lens_cancel_bill);
...
//        }
        ...
        tv_title.setText("【镜片无单入库撤销】 "+sysUserInfo.getAccountSetName());
            ...
            switch (msg.what) {
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.prints("         有单入库撤销", mark, sacnDataList, sysUserInfo.getUserName());

                    } else {

                        printbill.print(P_Dv_InStock_Lens_NoBill_Cancel.this, "         有单入库撤销", mark, sacnDataList, sysUserInfo.getUserName());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_InStock_Lens_NoBill_Cancel", para.toJson());
//                    Log.d("main",result);
                    if (result == "") {
                        MySound.errorSound();

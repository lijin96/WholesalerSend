...
/**
 * @ClassName: P_Dv_OutStock_Lens_Z_L_Bill_Cancel
 * @Description: 镜片有单分店发货撤销
 * @Author: lijin
 * @Date: 2024年3月27日15:24:45
 */
public class P_Dv_OutStock_Lens_Z_L_Bill_Cancel extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_outstock_lens_z_l_bill_cancel);
...
//        }
        ...
        tv_title.setText("【有单镜片分店发货撤销】 "+sysUserInfo.getAccountSetName());
...
//                    tv_model_colors.setText(modelm + "-" + colors);
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.prints("     有单分店发货撤销", mark, sacnDataList, sysUserInfo.getUserName());

                    } else {

                        printbill.print(P_Dv_OutStock_Lens_Z_L_Bill_Cancel.this, "     有单分店发货撤销", mark, sacnDataList, sysUserInfo.getUserName());
...
//                    Log.d("main", para.toJson());
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_OutStock_D_L_Lens_Bill_Cancel", para.toJson());

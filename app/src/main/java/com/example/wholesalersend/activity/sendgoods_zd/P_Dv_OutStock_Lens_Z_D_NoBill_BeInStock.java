 ...
 */
public class P_Dv_OutStock_Lens_Z_D_NoBill_BeInStock extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_outstock_lens_z_d_nobill_beinstock);
...
//        mSpinner = (Spinner) findViewById(R.id.spinner_type);
        ...
        supplier_name = gIntent.getStringExtra("company_name");
...
//                    mark[2] = "客户别名：" + tv_company_name.getText().toString();
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.print(P_Dv_OutStock_Lens_Z_D_NoBill_BeInStock.this, "    有单有入库代销发货", mark, sacnDataList, sysUserInfo.getUserid());
...
//                    Log.i("main", para.toJson());
                    result = accWeb.P_Dv_Scan("P_Dv_OutStock_D_L_Lens_NoBill", para.toJson());
...
//
    ...
    private class BtnSelectProductClick implements View.OnClickListener {
        @Override
        public void onClick(View v) {
            sysUserInfo.setIsDownload(false);//每次选择确认是否下载配货单明细数据

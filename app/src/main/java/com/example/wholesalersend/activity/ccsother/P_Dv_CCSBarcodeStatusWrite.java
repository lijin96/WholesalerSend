...
/**
 * @ClassName: P_Dv_CCSBarcodeStatusWrite
 * @Description: CCS换货补标
 * @Author: lijin
 * @Date: 2025/3/10 14:06
 */
public class P_Dv_CCSBarcodeStatusWrite extends Activity {
    ...
    private String stock_id = "", stock_name = "", CCSbrand_id = "", CCSbrand_name = "",CCSBranding_Code="";
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_ccsbarcodestatuswrite);
...
//        }
        ...
        tv_title.setText("【CCS换货补扫】 "+sysUserInfo.getAccountSetName());
        ...
        CCSbrand_id = gIntent.getStringExtra("BrandCode");
        CCSbrand_name = gIntent.getStringExtra("BrandName");
        CCSBranding_Code=gIntent.getStringExtra("BrandingCode");
        ...
        tv_curqty.setText("0");
        tv_billno.setText("");
        tv_company_name.setText(CCSbrand_name);
...
//                    mark[0] = "换货单：" + mBillNo;
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.prints("         CCS换货补标", mark, sacnDataList, sysUserInfo.getUserName());

                    } else {

                        printbill.print(P_Dv_CCSBarcodeStatusWrite.this, "         CCS换货补标", mark, sacnDataList, sysUserInfo.getUserName());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    para.setBillNo("");
                    para.setBrandCode(CCSbrand_id);
                    para.setStockId(stock_id);

                    result = accWeb.P_Dv_Scan("P_Dv_CCSBarcodeStatusWrite", para.toNoBillJson());
                    ...
                    nSize++;
                    //true;L9047-COL.2,L9047,COL.2,0,3010106719214747,0,华南1仓(深圳)
//                    true;L9047-COL.2,L9047,COL.2,1,3010106719214747,1,华南1仓(深圳)
                    goodsid = rest[0].trim();
                    modelm = rest[1].trim();
                    colors = rest[2].trim();

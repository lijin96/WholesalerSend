...
/**
 * @ClassName: P_Dv_ReturnedPurchase_Lens_D_L_NoBill
 * @Description: 镜片分店无单退货
 * @Author: lijin
 * @Date: 2021/3/10 10:24
 */
public class P_Dv_ReturnedPurchase_Lens_Z_L_NoBill extends Activity {
...
//	Thread send ;
    ...
    private Boolean IsBindCCS=false,IsSendToStore=false;
    ...
    private RelativeLayout relayout_ccsstore;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_returnedpurchase_lens_z_l_nobill);
        ...
        if (Scan_aim.equals("P_Dv_ReturnedPurchase_Lens_Z_L_NoBill")){
            tv_title.setText("【镜片无单选客退货】 "+sysUserInfo.getAccountSetName());
        }else{
            tv_title.setText("【镜片无单扫描退货】 "+sysUserInfo.getAccountSetName());
        }
...
//                showPopListView();
        ...
        bth_choosebrand.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("trader_sysid", "");
                intent.putExtra("store_sysid","");
                startActivityForResult(intent, Lic_SelectCCSBrand);
            }
        });

        btn_ChooseCCSData=findViewById(R.id.btn_ChooseCCSData);
...
//            relayout_ccsstore.setVisibility(View.GONE);
        }else if (Scan_aim.equals("P_Dv_ReturnedPurchase_Lens_Z_L_NoBill")){
            relayout_ccscustomer.setVisibility(View.VISIBLE);
...
//                    tv_model_colors.setText(modelm + "-" + colors);
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.print(P_Dv_ReturnedPurchase_Lens_Z_L_NoBill.this, "         退货单", mark, sacnDataList, sysUserInfo.getUserName());
                ...
                case 10:
                    ...
                    {
                        curcount=map.get("Num").toString();
                        refreshNum = refreshNum + Integer.valueOf(map.get("Num").toString());
                    }
                    tv_curqty.setText(curcount);
    ...
    private class BtRefreshClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Thread sendprint = new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        sacnDataList = accWeb.GetDowLoadLensScanBarcode(sysUserInfo.getLoginid(), scanBillno);
...
//	}
    ...
    private void access_send(final String contents) {
        if ((!sysUserInfo.getLoginType().equals("CCS")||sysUserInfo.getMainAccount().equals("U_1000820"))&&Scan_aim.equals("P_Dv_ReturnedPurchase_Lens_Z_L_NoBill")) {
            if (BrandCode.equals("")) {
                MySound.errorSound();
                ShowMessage.ShowMsg(handler, "请先选择品牌");
                return;
...
//                    Log.d("main",para.toJson());
                    ...
                    if (Scan_aim.equals("P_Dv_ReturnedPurchase_Lens_Z_L_NoBill")){
                        result = accWeb.P_Dv_Scan("P_Dv_ReturnedPurchase_Lens_D_L_NoBill", para.toNoBillJson());
                    }else{
                        result = accWeb.P_Dv_Scan("P_Dv_ReturnedPurchase_Lens_D_L_NoBill_NoCust", para.toNoBillJson());
                    }
//                    Log.d("main",result);
                    ...
                    nSize++;
                    //产品代号+折射率+球镜+柱镜+此产品扫描数量+条码+单据编号+单据扫描数量+客户代号+客户名称+门店代号+门店名称
                    goodsid = rest[0].trim();
                    ...
                    if (!Scan_aim.equals("P_Dv_ReturnedPurchase_Lens_Z_L_NoBill")){
                        retail_name= rest[9].trim();
                        TraderAlias_name=rest[10].trim();
                        company_name= rest[12].trim();
                    }

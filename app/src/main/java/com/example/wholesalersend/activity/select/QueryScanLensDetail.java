 ...
 * @Description: 镜片扫描明细查看
 * @Author: lijin
 * @Date: 2021/3/10 9:55
 */
public class QueryScanLensDetail extends Activity {
    AccessWeb accWeb;
...
//		et_search.addTextChangedListener(new EditTextChnangeListener());
        ...
        MyProgressDialog.show(QueryScanLensDetail.this, "", true, true);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case ShowMessage.HandShowMessage: // 显示错误提示显示
                    MyProgressDialog.close();
                    ShowMessage.Show(QueryScanLensDetail.this, msg.obj.toString());
                    break;

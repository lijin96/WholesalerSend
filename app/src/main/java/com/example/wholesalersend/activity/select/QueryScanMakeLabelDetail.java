...
/**
 * @ClassName: QueryScanMakeLabelDetail
 * @Description: java类作用描述
 * @Author: lijin
 * @Date: 2024/11/7 16:47
 */

public class QueryScanMakeLabelDetail extends Activity {
    AccessWeb accWeb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_query_scan_makelabel_detail);
...
//		et_search.addTextChangedListener(new EditTextChnangeListener());
        ...
        MyProgressDialog.show(QueryScanMakeLabelDetail.this, "", true, true);
...
//                            .QueryDbList(
//                                    "select goodsid,modelm,colors,sum(curcount) as curcount
//                                    from newscandate GROUP BY goodsid",
//                                    null);
//                } else {
                slist = accWeb.GetMendLableDetail(mBillNo);
//                slist = accWeb.GetDowLoadBilldetail("163125128103241181193187",
//                "18682075683S18838316614195263");
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case ShowMessage.HandShowMessage: // 显示错误提示显示
                    MyProgressDialog.close();
                    ShowMessage.Show(QueryScanMakeLabelDetail.this, msg.obj.toString());
                    break;
...
//        Collections.sort(mList, new SortListMapComparator("modelm"));
        ...
        SimpleAdapter adapter = new SimpleAdapter(QueryScanMakeLabelDetail.this, mList,
                R.layout.list_scan_makelabel_detail, new String[]{"GoodsCode", "BrandName",
                "Specifications", "Num"}, new int[]{R.id.txt_brand, R.id.txt_list1,
                R.id.txt_refractive, R.id.txt_list2});
...
//            lsv_searchSql = "select goodsid,modelm,colors,sum(curcount) as curcount from
//            newscandate where " +
//                    "goodsid like '%%" + lsv_etStr + "%%' or " +
//                    "modelm like '%%" + lsv_etStr + "%%' or " +
//                    "colors like '%%" + lsv_etStr + "%%' GROUP BY goodsid";
//            searchList.clear();
//            searchList = SqliteDataHelper.getHelper(getApplicationContext()).QueryDbList
//            (lsv_searchSql, null);

...
/**
 * @ClassName: P_Dv_ReturnedPurchase_Z_G_NoBill
 * @Description: 无单入库退回
 * @Author: lijin
 * @Date: 2021/3/10 11:05
 */
public class P_Dv_ReturnedPurchase_Z_G_NoBill extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_returnedpurchase_z_g_nobill);
...
//        }
        ...
        tv_title.setText("【无单入库退回】 "+sysUserInfo.getAccountSetName());

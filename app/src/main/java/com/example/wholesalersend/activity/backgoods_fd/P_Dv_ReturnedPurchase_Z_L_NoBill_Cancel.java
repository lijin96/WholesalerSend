...
/**
 * @ClassName: P_Dv_ReturnedPurchase_Z_L_NoBill_Cancel
 * @Description: 无单(分店)退货撤消
 * @Author: lijin
 * @Date: 2021/3/10 10:24
 */
public class P_Dv_ReturnedPurchase_Z_L_NoBill_Cancel extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_returnedpurchase_z_d_nobill_cancel);
...
//        }
        ...
        tv_title.setText("【无单分店退货撤销】 "+sysUserInfo.getAccountSetName());
            ...
            switch (msg.what) {
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.print(P_Dv_ReturnedPurchase_Z_L_NoBill_Cancel.this, "     无单分店退货撤销", mark, sacnDataList, sysUserInfo.getUserName());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_ReturnedPurchase_D_L_NoBill_Cancel", para.toJson());
                    if (result == "") {
                        MySound.errorSound();

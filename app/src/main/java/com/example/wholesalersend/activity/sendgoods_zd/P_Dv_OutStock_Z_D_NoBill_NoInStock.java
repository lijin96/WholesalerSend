 ...
 */
public class P_Dv_OutStock_Z_D_NoBill_NoInStock extends Activity {
    ...
    private Button btn_d_nobill_noinstock_revoke;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_outstock_z_d_nobill_noinstock);
...
//        }
        ...
        btn_d_nobill_noinstock_revoke = (Button) findViewById(R.id.btn_d_nobill_noinstock_revoke);
        btn_d_nobill_noinstock_revoke.setOnClickListener(new View.OnClickListener() {
...
//                R.layout.new_p_dv_outstock_z_d_nobill_noinstock, null);
//        if (mPopWindow == null) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 8:
                    ...
                    mark[0] = "发货单：" + mBillNo;
                    mark[1] = "零售商：" + tv_company_name.getText().toString();
                    mark[2] = "仓   库 ：" + tv_stock_name.getText().toString();

                    if (sysUserInfo.getOldVersion().equals("T8")) {

                        printbill.prints("    无单无入库代销发货", mark, sacnDataList, sysUserInfo.getUserid());

                    } else {

                        printbill.print(P_Dv_OutStock_Z_D_NoBill_NoInStock.this, "    无单无入库代销发货", mark, sacnDataList, sysUserInfo.getUserid());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_OutStock_D_L_NoBill_NoInStock", para.toJson());

                    //					Log.i("main", nScanCount+"---返回--result="+result);
                    if (result == "") {
                        MySound.errorSound();
                        ShowMessage.ShowMsg(handler, "网络不给力，请稍后再试！");
                        return;

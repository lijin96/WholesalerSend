...
/**
 * @ClassName: P_Dv_OutStock_Z_L_NoBill_Cancel
 * @Description: 无单分店发货撤销
 * @Author: lijin
 * @Date: 2021/3/10 14:03
 */
public class P_Dv_OutStock_Z_L_NoBill_Cancel extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_outstock_z_d_nobill_cancel);
...
//        }
        ...
        tv_title.setText("【无单分店发货撤销】 "+sysUserInfo.getAccountSetName());
            ...
            switch (msg.what) {
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.prints("     无单分店发货撤销", mark, sacnDataList, sysUserInfo.getUserName());

                    } else {

                        printbill.print(P_Dv_OutStock_Z_L_NoBill_Cancel.this, "     无单分店发货撤销", mark, sacnDataList, sysUserInfo.getUserName());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_OutStock_D_L_NoBill_Cancel", para.toJson());
...
//					if (!SomeUtils.TextJudgmentSize(et_barcode.getText().toString().trim())) {
//						MySound.errorSound();

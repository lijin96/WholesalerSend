...
public class P_Dv_OutStock_Z_D_NoBill_BeInStock extends Activity {
    ...
    private String scanBillno = "", mBillNo = "", company_id = "", company_name = "",custsys_code="";
    private String curcount = "0", goodsid = "", stock_id = "", stock_name = "",alias_name="";
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_OutStock_D_L_NoBill", para.toJson());
                    if (result == "") {
                        MySound.errorSound();
                        ShowMessage.ShowMsg(handler, "网络不给力，请稍后再试！");
                        return;

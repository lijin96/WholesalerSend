...
/**
 * @ClassName: P_Dv_OutStock_Z_L_Bill_BeInStock
 * @Description: 分店有单有入库分店发货
 * @Author: lijin
 * @Date: 2021/3/10 14:03
 */
public class P_Dv_OutStock_Z_L_Bill_BeInStock extends Activity {
...
//	private List<String> codesList= new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_outstock_z_l_bill_beinstock);
...
//        }
        ...
        tv_title.setText("【有单有入库有明细分店发货】 "+sysUserInfo.getAccountSetName());
            ...
            switch (msg.what) {
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.print(P_Dv_OutStock_Z_L_Bill_BeInStock.this, "    有单有入库直销发货", mark, sacnDataList, sysUserInfo.getUserName());

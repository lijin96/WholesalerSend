 ...
 * @Description: 镜片无单发货撤销
 * @Author: lijin
 * @Date: 2024年3月27日15:05:37
 */
public class P_Dv_OutStock_Lens_Z_D_NoBill_Cancel extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_outstock_lens_z_d_nobill_cancel);
...
//        }
        ...
        tv_title.setText("【无单镜片发货撤销】 "+sysUserInfo.getAccountSetName());
...
//                    tv_model_colors.setText(modelm + "-" + colors);
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.prints("     无单镜片发货撤销", mark, sacnDataList, sysUserInfo.getUserid());

                    } else {

                        printbill.print(P_Dv_OutStock_Lens_Z_D_NoBill_Cancel.this, "     无单镜片发货撤销", mark, sacnDataList, sysUserInfo.getUserid());

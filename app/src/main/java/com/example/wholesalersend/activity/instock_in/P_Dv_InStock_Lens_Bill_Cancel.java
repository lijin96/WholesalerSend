 ...
 */
public class P_Dv_InStock_Lens_Bill_Cancel extends Activity {
...
//        }
        ...
        tv_title.setText("【镜片有单入库撤销】 "+sysUserInfo.getAccountSetName());
            ...
            switch (msg.what) {
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.print(P_Dv_InStock_Lens_Bill_Cancel.this, "         有单入库撤销", mark, sacnDataList, sysUserInfo.getUserName());
        ...
        Thread sendCode = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    result = accWeb.P_Dv_Scan("P_Dv_InStock_Lens_Bill_Cancel", para.toJson());
//                    Log.d("main",result);
                    if (result == "") {
                        MySound.errorSound();

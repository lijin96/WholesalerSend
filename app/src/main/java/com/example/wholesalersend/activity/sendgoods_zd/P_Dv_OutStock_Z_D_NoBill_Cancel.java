 ...
 */
public class P_Dv_OutStock_Z_D_NoBill_Cancel extends Activity {
            ...
            switch (msg.what) {
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.prints("      无单代销发货撤销", mark, sacnDataList, sysUserInfo.getUserid());

                    } else {

                        printbill.print(P_Dv_OutStock_Z_D_NoBill_Cancel.this, "      无单代销发货撤销", mark, sacnDataList, sysUserInfo.getUserid());

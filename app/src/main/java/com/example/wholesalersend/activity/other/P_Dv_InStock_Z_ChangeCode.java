...
import com.example.wholesalersend.activity.select.QueryChangeCodeDetail;
import com.example.wholesalersend.entity.ChangeCodePara;
...
//                        colors = rest[2].trim();
//                    }
                    result =accWeb.PostAPIStringInterface("AndroidDv/ChangeLabel", codePara.toJson());
                    JSONObject jsonObject = new JSONObject(result);

                    product_id = jsonObject.optString("goodsCode");

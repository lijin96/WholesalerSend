...
/**
 * @ClassName: P_Dv_OutStock_Z_D_Bill_Cancel
 * @Description: 有单代销发货撤销
 * @Author: lijin
 * @Date: 2021/3/10 14:02
 */
public class P_Dv_OutStock_Z_D_Bill_Cancel extends Activity {
...
//	Thread send ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_p_dv_outstock_z_d_bill_cancel);
            ...
            switch (msg.what) {
                ...
                case 8:
                    ...
                    if (sysUserInfo.getOldVersion().equals("T8")) {
                        ...
                        printbill.prints("     有单代销发货撤销", mark, sacnDataList, sysUserInfo.getUserid());

                    } else {

                        printbill.print(P_Dv_OutStock_Z_D_Bill_Cancel.this, "     有单代销发货撤销", mark, sacnDataList, sysUserInfo.getUserid());

...
public class SysUserInfo {
    ...
    public String getApkUrl()
    {
        ...
        {
            String downapk="http://www.4006889521.cn/softupdate/Android/Dev/W1/scs5v01.apk";
//            if (!getServerip().equals("scs.holyes.net")){
//                downapk="http://www.4006889521.cn/softupdate/Android/Dev/W2/scs5v01.apk";
//            }
            return downapk;
        }else {
    ...
    {
        if (ReadConfigString("accountSetName").isEmpty())
        {
            return "批发商发货通";
        }
        return ReadConfigString("accountSetName");
    }

    public String getAccountSetId()
    {
        return ReadConfigString("accountSetId");
    }
    ...
    {
        return ReadConfigString("logintoken");
    }
...
//        {
        //总公司模式
//            return "http://www.4006889521.cn/softupdate/Android/Dev/W1/ver01.xml";
        String downapk="http://www.4006889521.cn/softupdate/Android/Dev/W1/ver01.xml";
//        if (getServerip().equals("scs.holyes.net")){
//            downapk="http://www.4006889521.cn/softupdate/Android/Dev/W2/ver01.xml";
//        }
        return downapk;
//        }else{
...
//        }
    ...
    public String getServerip()
    {
        ...
        rest = rest.isEmpty() ? "scs.holyes.net" : rest;//合力思
//        rest = rest.isEmpty() ? "hs.ccs2008.com" : rest;//批发商
        return rest;
    }
    /**
    ...
    {
        String rest = ReadConfigString("InterfaceAddress").trim();
        rest = rest.isEmpty() ? "ScsAndroid" : rest;//合力思
        return rest;
//        String rest ="ScsAndroid";
//        return rest;
    }
    ...
    {
        return ReadConfigString("seachvalue");
    }
    ...
    public void setInterfaceAdress(String tInterfaceAdress)
    {
        SaveConfigString("InterfaceAddress", tInterfaceAdress);
    }
    ...
    {
        SaveConfigString("accountSetName", accountSetName);
    }

    public void setAccountSetId(String accountSetId)
    {
        SaveConfigString("accountSetId", accountSetId);
    }
    ...
    {
        SaveConfigString("logintoken", logintoken);
    }
    public void setUserCode(String usercode)
    {
        SaveConfigString("usercode", usercode);
    }
...
//	}
    ...
    public void setSeachValue(String tseachvalue)
    {
        SaveConfigString("seachvalue", tseachvalue);
    }
    ...
    {
        SaveConfigString("username", username);
    }
     ...
     * @param deviceName
     */
    public void setPackingBluetoothName(String deviceName)
    {
        SaveConfigString("packingDeviceName", deviceName);
    }
    /**
     * 获取装盒入库界面连接的蓝牙名称
     * @return
     */
    public String getPackingBluetoothName()
    {
        return ReadConfigString("packingDeviceName");
    }
     ...
     * @param deviceAddress
     */
    public void setPackingBluetoothAddress(String deviceAddress)
    {
        SaveConfigString("packingDeviceAddress", deviceAddress);
    }
    /**
     * 获取装盒入库界面连接的蓝牙地址
     * @return
     */
    public String getPackingBluetoothAddress()
    {
        return ReadConfigString("packingDeviceAddress");
    }


    /**
     * 写入api scs2.0test 还是scs2.0
     * @param tAPIEndpoint
     */
    public void setAPIEndpoint(String tAPIEndpoint)
    {
        SaveConfigString("APIEndpoint", tAPIEndpoint);
    }

    //获取上次是正式版还是测试版
    public String getAPIEndpoint()
    {
        String rest = ReadConfigString("APIEndpoint").trim();
        rest = rest.isEmpty() ? "SCS2.0" : rest;
        return rest;
    }

    public void setOldVersion(String tOldVersion)
    {
        SaveConfigString("OldVersion", tOldVersion);
    }

    //获取现在的机器是否是旧版机器T8
    public String getOldVersion()
    {
        String rest = ReadConfigString("OldVersion").trim();
        rest = rest.isEmpty() ? "T9" : rest;
        return rest;
    }

    //当前登录的是ccs还是scs，默认是scs
    public String getLoginType()
    {
        String rest = ReadConfigString("LoginType").trim();
        rest = rest.isEmpty() ? "SCS" : rest;
        return rest;
    }
    public void setLoginType(String LoginType)
    {
        SaveConfigString("LoginType",LoginType);
    }

    /**
     * 写入CCS域名下，登录模式是品牌商还是其他
     * @param mode
     */
    public void setCCSLoginMode(String mode)
    {
        SaveConfigString("ccsloginmode", mode);
    }
    /**
     * 获取CCS域名下，登录模式是品牌商还是其他
     * @return
     */
    public String getCCSLoginMode()
    {

...
//
    ...
    private String BrandName;//品牌名称 用于品牌码入库功能
    ...
    public void setGoodsOrderType(String goodsOrderType) {
    ...
    public String toBrandJson() throws JSONException {
        JSONObject js = new JSONObject();
        js.put("Barcode", getBarcode());
        js.put("GoodsId", getGoodsId());
        js.put("SoCompId", getSoCompId());
